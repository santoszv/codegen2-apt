...
private fun writeFind(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    ...
    bufferedWriter.appendLine("""        return find${classModel.methodsSuffix}(id, null);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    ...
    bufferedWriter.appendLine("""            entity = this.getEntityManager().find(${classModel.qualifiedName}.class, id);""")
    bufferedWriter.appendLine("""        } else {""")
    bufferedWriter.appendLine("""            entity = this.getEntityManager().find(${classModel.qualifiedName}.class, id, lockMode);""")
    bufferedWriter.appendLine("""        }""")
    ...
    bufferedWriter.appendLine("""        return find${classModel.methodsSuffix}OrNull(id, null);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
