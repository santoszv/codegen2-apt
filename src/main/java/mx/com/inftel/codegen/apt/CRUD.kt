...
private fun writeFind(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    ...
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default ${classModel.dtoName} find${classModel.capitalizedName}OrNull(${idPropertyType} id) {""")
    bufferedWriter.appendLine("""        ${classModel.qualifiedName} entity = this.getEntityManager().find(${classModel.qualifiedName}.class, id);""")
    bufferedWriter.appendLine("""        if (entity == null) {""")
...
private fun writeCreate(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default ${classModel.dtoName} create${classModel.capitalizedName}(${classModel.dtiName} data) {""")
...
private fun writeUpdate(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    ...
    val idPropertyType = idPropertyModel.propertyType.toNonNullable().toCode()
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default ${classModel.dtoName} update${classModel.capitalizedName}(${idPropertyType} id, ${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        ${classModel.qualifiedName} entity = this.getEntityManager().find(${classModel.qualifiedName}.class, id);""")
    bufferedWriter.appendLine("""        if (entity == null) {""")
    bufferedWriter.appendLine("""            throw new IllegalArgumentException("Entity Not Found");""")
    bufferedWriter.appendLine("""        }""")
    ...
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default ${classModel.dtoName} update${classModel.capitalizedName}OrNull(${idPropertyType} id, ${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        ${classModel.qualifiedName} entity = this.getEntityManager().find(${classModel.qualifiedName}.class, id);""")
    bufferedWriter.appendLine("""        if (entity == null) {""")
    bufferedWriter.appendLine("""            return null;""")
    bufferedWriter.appendLine("""        }""")
...
private fun writeDelete(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    ...
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default ${classModel.dtoName} delete${classModel.capitalizedName}OrNull(${idPropertyType} id) {""")
    bufferedWriter.appendLine("""        ${classModel.qualifiedName} entity = this.getEntityManager().find(${classModel.qualifiedName}.class, id);""")
    bufferedWriter.appendLine("""        if (entity == null) {""")
    bufferedWriter.appendLine("""            return null;""")
    bufferedWriter.appendLine("""        }""")
...
private fun writeCountContext(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    final class CountContext extends mx.com.inftel.codegen.CountContext<${classModel.qualifiedName}> {""")
    bufferedWriter.appendLine("""""")
...
private fun writeListContext(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    final class ListContext extends mx.com.inftel.codegen.ListContext<${classModel.qualifiedName}> {""")
    bufferedWriter.appendLine("""""")
